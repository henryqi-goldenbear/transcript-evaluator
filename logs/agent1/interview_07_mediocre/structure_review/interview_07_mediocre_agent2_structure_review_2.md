...
Iteration: 2
Satisfied: False
Summary: Several follow-ups are misplaced and need to be corrected.
...
[
  {
    ...
    "problem": "Follow-up is attached to the wrong parent case.",
    "correction": "Move follow-up to the correct parent case."
  },
  {
    "severity": "high",
    "case_id": 4,
  ...
  },
  {
    ...
    "problem": "Follow-up should be its own case.",
    "correction": "Split follow-up into its own case."
  }
]
...
[
  {
    "op": "move_follow_up",
    "reason": "Follow-up belongs to the technical question about ledger systems.",
    "source_case_id": 2,
    "target_case_id": 3,
  ...
  {
    "op": "move_follow_up",
    "reason": "Follow-up belongs to the question about conflict within the team.",
    "source_case_id": 4,
    "target_case_id": 5,
  ...
  },
  {
    ...
    "reason": "Follow-up is a separate behavioral question.",
    "source_case_id": 7,
    "target_case_id": null,
    "follow_up_question": "Have you ever identified a process or tool that was slowing your team down? How did you go about improving it?",
