...
Iteration: 8
Satisfied: False
Summary: Some questions are misclassified as follow-ups and need restructuring.
...
[
  {
    ...
    "problem": "This question should be a follow-up to the ledger system design question.",
    "correction": "Move this question as a follow-up to the ledger system design question."
  },
  {
    "severity": "high",
    "case_id": 4,
    "question": "How did you get both of them to agree to the testing approach?",
    "problem": "This question should be a follow-up to the conflict resolution question.",
    "correction": "Move this question as a follow-up to the conflict resolution question."
  },
  {
    "severity": "high",
    "case_id": 8,
    "question": "How did you get buy-in for that change? Did you have to convince anyone?",
    "problem": "This question should be a follow-up to the process improvement question.",
    "correction": "Move this question as a follow-up to the process improvement question."
  }
]
...
[
  {
    "op": "move_follow_up",
    "reason": "This question is a follow-up to the ledger system design question.",
    "source_case_id": 1,
    "target_case_id": 2,
  ...
  {
    "op": "move_follow_up",
    "reason": "This question is a follow-up to the conflict resolution question.",
    "source_case_id": 4,
    "target_case_id": 5,
  ...
  {
    "op": "move_follow_up",
    "reason": "This question is a follow-up to the process improvement question.",
    "source_case_id": 8,
    "target_case_id": 9,
