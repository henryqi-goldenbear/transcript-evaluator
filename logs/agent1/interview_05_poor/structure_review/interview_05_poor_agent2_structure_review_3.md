...
Iteration: 3
Satisfied: False
Summary: Some follow-ups need to be attached to the correct parent cases.
...
[
  {
    ...
    "problem": "Follow-up question is not attached to the correct parent case.",
    "correction": "Move the follow-up question to the correct parent case."
  },
  {
    "severity": "medium",
    "case_id": 2,
    "question": "What kind of metrics did you use to measure success, and how did the system perform against those?",
    "problem": "This should be a follow-up to the recommendation systems question.",
    "correction": "Attach this question as a follow-up to the recommendation systems question."
  }
]
...
[
  {
    "op": "move_follow_up",
    "reason": "Follow-up question should be attached to the correct parent case.",
    "source_case_id": 1,
    "target_case_id": 1,
    "follow_up_question": "Interesting. Can you tell me more about the recommendation systems you\u2019ve worked on? What was the scale, and what kind of impact did they have?",
    "question": "",
  ...
  {
    "op": "move_follow_up",
    "reason": "This question should be a follow-up to the recommendation systems question.",
    "source_case_id": 2,
    "target_case_id": 1,
