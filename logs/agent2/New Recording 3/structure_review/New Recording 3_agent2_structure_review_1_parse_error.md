...
{
  "satisfied": false,
  "summary": "The current structure needs significant reorganization to separate main questions and properly attach follow-ups.",
  "issues": [
    {
      "severity": "high",
      "case_id": null,
      "question": "What brings you to Visa, where you want to go in your career.",
      "problem": "Main interview question is missing as a standalone case.",
      "correction": "Add this as a new case."
    },
    {
      "severity": "high",
      "case_id": null,
    ...
    },
    {
      ...
      "problem": "This is a non-behavioral introduction and should be omitted.",
      "correction": "Remove this case."
    }
  ],
  "operations": [
    {
      "op": "remove_case",
      "reason": "This is a non-behavioral introduction and should be omitted.",
      "source_case_id": 1,
      "target_case_id": null,
      "follow_up_question": "",
      "question": "",
    ...
    {
      "op": "add_missing_case",
      "reason": "Main interview question should be a standalone case.",
      "source_case_id": null,
      "target_case_id": null,
      "follow_up_question": "",
      "question": "What brings you to Visa, where you want to go in your career.",
