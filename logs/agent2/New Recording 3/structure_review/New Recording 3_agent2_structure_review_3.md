...
Iteration: 3
Satisfied: False
Summary: Several follow-ups and missing cases identified.
...
[
  {
    ...
    "correction": "Add follow-ups for clarifying questions about the GUI."
  },
  {
    "severity": "high",
    "case_id": 3,
    ...
    "problem": "Missing follow-ups for clarifying questions.",
    "correction": "Add follow-ups for clarifying questions about the model and outage."
  },
  {
    "severity": "medium",
    "case_id": null,
    ...
    "correction": "Promote to a standalone case."
  },
  {
    "severity": "medium",
    "case_id": null,
...
[
  {
    "op": "add_missing_case",
    "reason": "Independent question should be a standalone case.",
    "source_case_id": null,
    "target_case_id": null,
    "follow_up_question": "",
    "question": "Is that it?",
  ...
  {
    "op": "add_missing_case",
    "reason": "Follow-up question missing from current cases.",
    "source_case_id": 3,
    "target_case_id": null,
