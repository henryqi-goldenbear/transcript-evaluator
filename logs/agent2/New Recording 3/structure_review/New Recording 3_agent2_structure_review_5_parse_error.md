...
```json
{
  ...
  "issues": [
    {
      ...
      "problem": "Missing follow-ups that should be attached to this case.",
      "correction": "Add follow-ups to this case."
    },
    {
      "severity": "high",
      "case_id": 3,
  ...
  "operations": [
    {
      "op": "add_missing_case",
      "reason": "Follow-up question is missing from the case.",
      "source_case_id": null,
      "target_case_id": 2,
    ...
    },
    {
      ...
      "question": "",
      "response": "So at times, SDGE or San Diego Gas and Electric was the one who decided that they were going to plan an outage on certain lines, right? They were going to plan certain outages. They're taking lines out for maintenance or something else. Or whatever. Whatever that might be.",
      "turn_type": "",
      "probe_type": "clarifying"
    },
    {
      ...
      "question": "",
      "response": "Yeah, so on my model, on my model, it showed that, like, because of these, of, like, all these lines that were going to be out, that, like, there was not going to be any overload being caused on my model. But then on, well, I mean, on their model. On my model, it was showing that there was no overload, but on their model, it was showing that there was an overload.",
      "turn_type": "",
      "probe_type": "clarifying"
    },
    {
      ...
      "question": "",
      "response": "So then I kind of showed my evidence, and then I would send it to them, and then they would kind of send it back to me. And then the idea was, well we still can't agree, so then I send them kind of how I got to the point. And then ultimately, although I will say that we did decide to cancel the outage, but nonetheless, we still decided out of precaution to cancel it.",
      "turn_type": "",
    ...
    },
    {
      ...
      "source_case_id": null,
      "target_case_id": 3,
      "follow_up_question": "Better safe than sorry in this case. Because you couldn't decide which model was more accurate?",
      "question": "",
      "response": "It was more, well we decided, we just, well what was it? Okay. So we decided to cancel because, well their model was actually more accurate, but nonetheless we just still decided out of precaution to cancel it.",
      "turn_type": "",
      "probe_type": "deepening"
    },
    {
      ...
      "source_case_id": null,
      "target_case_id": 3,
      "follow_up_question": "But then I'm assuming there was a business reason they wanted to take the outage. So then how did they address the underlying business need to do the outage in the first place?",
      "question": "",
      "response": "Well, I mean, it's basically just based on their own repair schedule. Maybe they see some lines that they just want to check or maintain. But then
...
```json
{
  ...
  "operations": [
    ...
    },
    {
      ...
      "follow_up_question": "Okay, so there's this model for supplying energy to an area that includes capacity of the lines and usage and some other stuff. So was there an outage or something? Like, help me understand the...",
      "question": "",
      "response": "So at times, SDGE or San Diego Gas and Electric was the one who decided that they were going to plan an outage on certain lines, right? They were going to plan certain outages. They're taking lines out for maintenance or something else. Or whatever that might be.",
      "turn_type": "",
      "probe_type": "clarifying"
    },
    {
