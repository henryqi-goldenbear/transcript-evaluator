...
{
  "satisfied": false,
  "summary": "Several questions and follow-ups need to be restructured.",
  "issues": [
    {
      "severity": "high",
      "case_id": null,
      ...
      "problem": "Missing main question case",
      "correction": "Add as a new standalone case"
    },
    {
      "severity": "high",
      "case_id": null,
    ...
    },
    {
      ...
      "case_id": 1,
      "question": "Is that it?",
      "problem": "Follow-up question missing from case 1",
      "correction": "Add as a follow-up to case 1"
    },
    {
      "severity": "medium",
      "case_id": 1,
    ...
    },
    {
      ...
      "problem": "Follow-up question missing from case 2",
      "correction": "Add as a follow-up to case 2"
    },
    {
      "severity": "medium",
      "case_id": 2,
    ...
    },
    {
      "severity": "medium",
      "case_id": 2,
      "question": "And so you and a colleague get a different opinion on the model, specifically, like, what was the difference of opinion?",
      "problem": "Follow-up question missing from case 2",
      "correction": "Add as a follow-up to case 2"
    },
    {
      "severity": "medium",
      "case_id": 2,
      "question": "Okay. And then, so what did you guys do?",
      "problem": "Follow-up question missing from case 2",
      "correction": "Add as a follow-up to case 2"
    },
    {
  ...
  "operations": [
    {
      "op": "add_missing_case",
      "reason": "Missing main question case",
      "source_case_id": null,
      "target_case_id": null,
      "follow_up_question": "",
      "question": "walk me through a situation where you saw a problem or opportunity, but you weren't assigned to work on it specifically.",
      "response": "Wait, what was it? Yeah, yeah. So I kind of talked to you about how I built that GUI before, right? So one of the precursors that actually even began before that was just trying to automate just some really slow process that was happening.",
    ...
    },
    {
      ...
      "follow_up_question": "",
      "question": "describe a time when you witnessed behavior that made you uncomfortable or you felt was wrong or inappropriate at work or school.",
      "response": "Yeah, I mean, I will start with, what was it, with school because, well, I mean, in like tech, unfortunately, like I don't know if you see this, but like sometimes people who are like well privileged will sometimes try to claim that people who are not privileged...",
      "turn_type": "behavioral",
      "probe_type": ""
    },
    {
      ...
      "follow_up_question": "",
      "question": "Can you describe a situation where you had difficulty persuading someone to see your point of view?",
      "response": "Oh, difficulty in persuading. Oh, okay. Wait. Okay. Yeah, so there was this situation one time when we were trying to build a CPU. This was a couple years ago. And so the idea in that project was you have a pipeline...",
      "turn_type": "behavioral",
      "probe_type": ""
    },
    {
