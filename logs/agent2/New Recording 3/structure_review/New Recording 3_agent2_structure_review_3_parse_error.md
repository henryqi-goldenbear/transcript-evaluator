...
{
  "satisfied": false,
  "summary": "Follow-ups need to be attached to the correct parent cases and probe types need to be specified.",
  "issues": [
    {
      "severity": "high",
      "case_id": 2,
      "question": "Is that it?",
      "problem": "Follow-up question not attached to the correct parent case.",
      "correction": "Attach follow-up questions to the correct parent case and specify probe types."
    },
    {
      "severity": "high",
      "case_id": 2,
    ...
    },
    {
      "severity": "high",
      "case_id": 2,
      "question": "And then how did you create the original documentation? So you scanned the code base and then basically created the documentation out of the code base?",
      "problem": "Follow-up question not attached to the correct parent case.",
      "correction": "Attach follow-up questions to the correct parent case and specify probe types."
    },
    {
  ...
  "operations": [
    {
      "op": "move_follow_up",
      "reason": "Follow-up question needs to be attached to the correct parent case.",
      "source_case_id": null,
      "target_case_id": 2,
