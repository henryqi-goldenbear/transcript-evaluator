...
Iteration: 1
Satisfied: False
Summary: Several independent questions are incorrectly nested as follow-ups.
...
[
  {
    ...
    "problem": "This is an independent question incorrectly nested as a follow-up.",
    "correction": "This should be its own case."
  },
  {
    "severity": "medium",
    "case_id": 9,
    "question": "Can you give me an example of a time you used TypeScript to prevent a bug?",
    "problem": "This is a follow-up question but lacks a probe_type.",
    "correction": "This should have a probe_type of 'clarifying'."
  }
]
...
[
  {
    ...
    "reason": "This is an independent question incorrectly nested as a follow-up.",
    "source_case_id": 4,
    "target_case_id": null,
    "follow_up_question": "I see. How do you prioritize your work when you have multiple competing deadlines?",
    "question": "",
  ...
  },
  {
    ...
    "reason": "This is a follow-up question but lacks a probe_type.",
    "source_case_id": 9,
    "target_case_id": null,
    "follow_up_question": "Can you give me an example of a time you used TypeScript to prevent a bug?",
    "question": "",
    "response": "",
    "turn_type": "",
