...
FOLLOW_UP_PATTERNS = [
    ...
    re.compile(r"^\s*can you be more specific\b", re.IGNORECASE),
    ...
    re.compile(r"^\s*you said\b", re.IGNORECASE),
    ...
    re.compile(r"^\s*what was\b", re.IGNORECASE),
    re.compile(r"^\s*what were\b", re.IGNORECASE),
    re.compile(r"^\s*what did you\b", re.IGNORECASE),
    re.compile(r"^\s*what exactly\b", re.IGNORECASE),
    re.compile(r"^\s*what was your role\b", re.IGNORECASE),
    re.compile(r"^\s*how did\b", re.IGNORECASE),
    re.compile(r"^\s*how exactly\b", re.IGNORECASE),
    re.compile(r"^\s*how long\b", re.IGNORECASE),
    re.compile(r"^\s*how many\b", re.IGNORECASE),
    re.compile(r"^\s*how much\b", re.IGNORECASE),
    re.compile(r"^\s*why did\b", re.IGNORECASE),
    re.compile(r"^\s*who else\b", re.IGNORECASE),
...
CLARIFYING_PATTERNS = [
    ...
    re.compile(r"\bwhat was your role\b", re.IGNORECASE),
